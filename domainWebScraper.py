...
def main():
    ...
    while urlInput == None:
        ...
        if checkValidURL(urlInput) == False:
            urlInput = None
    fileNameInput = input("Please enter the file name for your CSV:\n")
    ...
    #Export as CSV
    print("Exporting as " + fileNameInput + ".csv")
    df = pd.DataFrame(processedData, columns=["StreetAddress","Suburb","Postcode","State","Bedrooms","Bathrooms","Parking","PropertyType","LandSize","LandUnit","SaleDate","Price"])
    df.to_csv(fileNameInput + ".csv")
